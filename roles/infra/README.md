...
| `dpdk_socket_path`                   | `str`  | `null`             |                     | Path for existing socket when using OVS with DPDK.                |
|                                      |        |                    |                     |                                                                   |
| `infra_hostname`                     | `str`  |                    | `n1a1`              | Defines on which HV machine the Front-end VM should be deployed.  |
| `infra_xml_variant`                  | `str`  | undefined          | `default`           | Defined which domain XML variant will be used in Libvirt.         |
|                                      |        |                    |                     |                                                                   |
